...
// # firstName, lastName, position, email, phone, payRate, username and
// # userPassword.
...
//       //# Response query will return the id, first_name, last_name, position, email, phone, pay_rate, username, and password_hash
//       const resSqlQuery = `select id, first_name, last_name, position, email, phone, pay_rate, username, password_hash from users where id = ?`;
